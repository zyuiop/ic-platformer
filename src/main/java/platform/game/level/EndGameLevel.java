...
public class EndGameLevel extends Level {
	...
	public void register(World world) {
		...
		try {
			...
			world.register(new TextBox(new Vector(0, 0), null, font, Color.BLACK, 0, 1, 2.5, 0, "Bravo !"));
			world.register(new TextBox(new Vector(0, -1), null, font, Color.BLACK, 0, 1, 5, 0, "Vous avez terminé le jeu"));
