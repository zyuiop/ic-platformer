...
public class Cave2 extends PlayableLevel {
	...
	public void register(World world) {
		...
		world.register(new Jumper(new Vector(2.75, 15.75), .5, .25, Direction.LEFT, power));
		world.register(new Jumper(new Vector(2.75, 15.25), .5, .25, Direction.LEFT, power));
		world.register(new Jumper(new Vector(2.75, 14.75), .5, .25, Direction.LEFT, power));
		world.register(new Jumper(new Vector(2.75, 14.25), .5, .25, Direction.LEFT, power));
		world.register(new Jumper(new Vector(2.75, 13.75), .5, .25, Direction.LEFT, power));
		world.register(new Jumper(new Vector(2.75, 13.25), .5, .25, Direction.LEFT, power));
